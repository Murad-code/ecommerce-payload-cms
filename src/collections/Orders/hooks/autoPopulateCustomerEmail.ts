 ...
 */
export const autoPopulateCustomerEmail: CollectionBeforeChangeHook<Order> = async ({
  data,
  req,
}) => {
 ...
 */
export const populateCustomerEmailOnRead: CollectionAfterReadHook<Order> = async ({ doc, req }) => {
